...
; OBJ-SDAG-NEXT:    s_lshr_b32 s0, __amdgpu_named_barrier.bars.cebb3cd1832bf92a6cb51d2898ea54dd@abs32@lo, 4
...
; OBJ-GISEL-NEXT:    s_lshr_b32 s0, __amdgpu_named_barrier.bars.cebb3cd1832bf92a6cb51d2898ea54dd@abs32@lo, 4
...
; OBJ-GISEL:       ; %bb.0:
; OBJ-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; OBJ-GISEL-NEXT:    s_add_co_u32 s0, __amdgpu_named_barrier.bars.cebb3cd1832bf92a6cb51d2898ea54dd@abs32@lo, 16
; OBJ-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
